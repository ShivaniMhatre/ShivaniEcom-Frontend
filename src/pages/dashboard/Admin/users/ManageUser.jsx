...
export default function ManageUser() {
    ...
    // Fetch user data using the useGetUserQuery hook
    const { data, isLoading, error, refetch } = useGetUserQuery();

    // Check if data is an array or if we need to access a specific property
    ...
    return (
        <>
                        ...
                        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                            ...
                            <div className="block w-full overflow-x-auto">
                                ...
                                <table className="items-center bg-transparent w-full border-collapse ">
                                    ...
                                    <tbody>
                                        {/* Iterate over users and render user data */}
                                        {users.length > 0 ? (
            ...
            {
                isModalOpen && <UpdateUser user={selectedUser} onClose={handleCloseModal} onRoleUpdate={refetch} />
            }
        </>
    );
}
