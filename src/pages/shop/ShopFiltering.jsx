...
export default function ShopFiltering({ filters, filtersState, setFiltersState, clearFilters }) {
    return (
        <div className='space-y-5 flex-shrink-0'>
            ...
            {/* Clear Filter Button */}
            <button className='bg-primary py-1 px-4 text-white rounded capitalize' onClick={clearFilters}>clear All</button>
        </div>
    )
}
